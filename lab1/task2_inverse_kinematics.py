...
def part1_animation(viewer, target_pos):
    ...
    class UpdateHandle:
        ...
        def update_func(self, viewer):
            ...
            self.joint_position, self.joint_orientation = part1_inverse_kinematics(meta_data, self.joint_position,
...
def part2(viewer, bvh_name):
    ...
    class UpdateHandle:
        ...
        def update_func(self, viewer):
            ...
            joint_position, joint_orientation = part2_inverse_kinematics(self.meta_data, joint_position,
                                                                         joint_orientation, 0.1, 0.3, 1.4)
...
def bonus(viewer, left_target_pos, right_target_pos):
    ...
    class UpdateHandle:
        ...
        def update_func(self, viewer):
            ...
            self.joint_position, self.joint_orientation = bonus_inverse_kinematics(meta_data, self.joint_position,
